export function renderNav(activeTab) {
  ...
  const menuItems = [
    ...
    { label: 'כרטיסיות טיפולים', href: '/punch-cards', icon: '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M9 8h6M9 12h6M9 16h4"/></svg>' },
